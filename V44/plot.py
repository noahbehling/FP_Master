...
uleft_FWHM = a/unp.sqrt(2*np.pi*s**2) * unp.exp(-(left_FWHM-m)**2/(2*s**2)) + b
uright_FWHM = a/unp.sqrt(2*np.pi*s**2) * unp.exp(-(right_FWHM-m)**2/(2*s**2)) + b
print (uright_FWHM)
